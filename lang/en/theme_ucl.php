...
$string['choosereadme'] = 'This theme has been created to show a very minimalist approach to adjusting a parent theme.<br/> The main parent theme in this case is essential (which itself has bootstrapbase as its parent). The config.php calls the essential layout files and a single style css file - core.css which holds only the changes made to the theme appearance.';
